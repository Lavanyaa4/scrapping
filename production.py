...
Original file is located at
    https://colab.research.google.com/drive/11d8ZObKvnQ_UhlbOvTmAceUKEgFL_Fca
"""
...
links= ['https://www.allthescience.org/what-is-chemical-production.htm',
        'https://www.sciencedirect.com/topics/engineering/chemical-production']
with open('production.csv','w',encoding='utf8',newline='') as f:
  thewriter=writer(f)   
  header=['websites'] 
...
df=pd.read_csv('/content/production.csv')
df
